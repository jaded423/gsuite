...
# ~/.config/gsuite-{elevated,dax,jaded,point4}/ (not created here — run `gsuite auth`
...
for pair in elevated:gsuite-elevated dax:gsuite-dax jaded:gsuite-jaded point4:gsuite-point4; do
  label=${pair%%:*}; cfg=${pair##*:}
